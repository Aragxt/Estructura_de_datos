...
class Cajas:
    ...
    def iniciarNueva(self,nuevaTarea):
        ...
        self.tiempoRestante = cantidad * (60/self.tasaProductos) + 120 #Cantidad de productos adquiridos * promedio de tiempo en registrar productos + 120 segundos del tiempo de pago y devolución de diero o pago con medios electrónicos
...
def simulacion1Fila(numeroSegundos, productosPorMinuto):   #Número de segundos para simulación y promedio de productos registrados por minuto en las cajas.
    ...
    print("Total productos vendidos: ",(caja1.contadorDeProductos+caja2.contadorDeProductos+caja3.contadorDeProductos))
...
for i in range(10):
    simulacion3Filas(3600,12)  
    print("")
    simulacion1Fila(3600,12)
    print("-------------------------------------------------------------")
